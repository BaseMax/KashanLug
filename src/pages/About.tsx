          ...
          <div class="relative max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-16">
              ...
              <p class="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
                جامعه‌ای مستقل از علاقه‌مندان به گنو/لینوکس، نرم‌افزار آزاد و فناوری‌های
                متن‌باز در کاشان.
              </p>
            </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 mb-20 items-start">
              <div class="space-y-5 text-gray-300 leading-relaxed">
                ...
                <p>
                  ...
                  کسب‌وکار و جامعه مدنی برگزار می‌شود. این رویداد آغازی است برای یک مسیر
                  طولانی‌تر.
                </p>
                <p>
                  باور داریم که دانش فنی باید آزادانه منتقل شود، ابزارهای آزاد در اختیار
                  همه باشد، و جامعه‌های محلی بتوانند مستقل از شرکت‌های بزرگ، مهارت و دانش
                  خود را بسازند.
                </p>
              </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-5 mb-20">
              {[
                ...
                <div class="bg-ink-900 border border-white/10 rounded-2xl p-6 text-center">
