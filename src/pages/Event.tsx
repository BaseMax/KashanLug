...
export const Event: m.Component = {
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <section class="mb-16">
              ...
              <div class="grid sm:grid-cols-2 gap-4">
                {topics.map((t, i) => (
                  <div class="flex items-start gap-4 p-5 rounded-2xl bg-ink-900 border border-white/10">
            ...
            <section class="mb-16">
              <div class="flex items-end justify-between gap-4 mb-8">
                ...
                <RouteLink href="/schedule" class="text-brand-400 hover:text-brand-300 font-bold text-sm">جزئیات بیشتر ›</RouteLink>
              </div>
              <div class="space-y-3">
                {schedule.map((slot) => {
                  ...
                  return (
                    <div class="flex items-center gap-4 p-4 rounded-2xl bg-ink-900 border border-white/10">
