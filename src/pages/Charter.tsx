...
export const Charter: m.Component = {
          ...
          <div class="relative max-w-3xl mx-auto px-4 sm:px-6">
            ...
            <div class="mt-14 pt-8 border-t border-white/10 text-center">
              <p class="text-gray-500 text-sm">
                این مرام‌نامه توسط هستهٔ اجرایی کاشان‌لاگ نوشته شده و در صورت اجماع جامعه
                قابل ویرایش است.
              </p>
              <div class="flex justify-center gap-4 mt-6">
                <RouteLink href="/about" class="text-brand-400 hover:text-brand-300 font-bold text-sm transition-colors">
                  دربارهٔ ما
                </RouteLink>
                <span class="text-gray-600">·</span>
                <RouteLink href="/join" class="text-brand-400 hover:text-brand-300 font-bold text-sm transition-colors">
                  همکاری
                </RouteLink>
              </div>
            </div>
