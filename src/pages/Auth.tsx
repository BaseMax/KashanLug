                  ...
                  {this.done ? (
                    ...
                    <form onsubmit={(e: Event) => this.verifyOtp(e)}>
                      <button type="button" onclick={() => { this.step = "phone"; }}
                        class="cursor-pointer flex items-center gap-2 text-gray-400 hover:text-white text-sm mb-7 transition-colors">
                      ...
                      <p class="text-gray-400 text-sm mb-8" dir="ltr">
                        کد ۶ رقمی ارسال‌شده به <span class="text-white">{this.phone}</span> را وارد کنید.
                      </p>
                      ...
                      <div class="text-center text-sm text-gray-500">
                        {resendTimer ? (
                          ...
                          <button type="button" onclick={() => { this.startResendTimer(); m.redraw(); }}
                            class="cursor-pointer text-brand-400 hover:text-brand-300 font-bold transition-colors">
                            ارسال مجدد کد
                          </button>
                        )}
                      </div>
