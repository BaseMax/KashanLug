...
export class Footer implements Mithril.ClassComponent {
  view() {
    return (
      <footer class="bg-ink-900 border-t border-white/5 pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            <div class="lg:col-span-2">
              <div class="flex items-center gap-3 mb-4">
                <img src={site.logo} alt="کاشان‌لاگ" class="w-10 h-10 rounded-xl" />
                <div class="font-black text-white text-lg">{site.name}</div>
              </div>
              ...
              <div class="flex items-center gap-3">
                <a href={site.telegram} target="_blank" rel="noopener"
                  class="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-all"
                  aria-label="تلگرام">
            ...
            <div>
              <h3 class="text-white font-bold mb-4 text-sm">ارتباط با ما</h3>
              <ul class="space-y-3 text-sm">
                <li>
                  <a href={`mailto:${site.email}`} class="text-gray-400 hover:text-white transition-colors break-all" dir="ltr">
                    {site.email}
                  </a>
                </li>
                <li>
                  <a href={site.telegram} target="_blank" rel="noopener" class="text-gray-400 hover:text-white transition-colors">
                    کانال تلگرام <span dir="ltr" class="ltr-inline">@KashanLUG</span>
                  </a>
                </li>
                <li>
                  <a href={site.telegramGroup} target="_blank" rel="noopener" class="text-gray-400 hover:text-white transition-colors">
                    گروه تلگرام <span dir="ltr" class="ltr-inline">@KashanLUG_gp</span>
                  </a>
                </li>
                <li class="text-gray-500">کاشان، ایران</li>
              </ul>
            </div>
          </div>

          <div class="pt-8 border-t border-white/5 flex flex-wrap items-center justify-between gap-4 text-xs text-gray-600">
            <span>© ۱۴۰۵ کاشان‌لاگ. قالب تحت لایسنس <span dir="ltr" class="ltr-inline">GPL-3.0</span> و همهٔ محتوا تحت لایسنس <span dir="ltr" class="ltr-inline">CC BY 4.0</span> منتشر می‌شود.</span>
